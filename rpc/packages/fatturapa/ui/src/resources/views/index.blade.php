            ...
            <div class="card col-md-6">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <button type="button" onclick="post('/sdi/rpc/resetTime');" class="btn mb-1 btn-primary">Ok,
                            resetta data e ora
                        </button>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input id="speed" type="number" min="1" max="1000000000" class="form-control"
                                   aria-label="speed">
                            <button type="button" onclick="post('/sdi/rpc/speed', 'speed', 'speed');"
                                    class="btn mb-1 btn-primary">Salva
                            </button>
                        </div>
                    </div>
                </div>  <!-- /.card-body -->
