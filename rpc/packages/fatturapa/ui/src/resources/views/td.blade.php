        ...
        <div class="container-fluid" id="tables" v-cloak>
            <div class="actions row">
                <div class="col-sm">
                    ...
                    <button type="button" onclick="post('/td{{$actor}}/rpc/clear');" class="btn mb-1 btn-danger">Resetta
                        il database
                    </button>
                </div>
            </div>
            ...
            <ul class="nav nav-tabs" role="tablist" style="margin-bottom: 20px;">
                <li class="nav-item">
                    <a class="nav-link active" id="emissione-tab" data-toggle="tab" href="#emissione" role="tab"
                       aria-controls="emissione" aria-selected="true">Emissione</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="ricezione-tab" data-toggle="tab" href="#ricezione" role="tab"
                       aria-controls="ricezione" aria-selected="false">Ricezione</a>
                </li>
            </ul>
                            ...
                            <div class="col-sm-6 offset-sm-3">
                                <form enctype="multipart/form-data" class="form-group" id="upload-form">
                                    <button type="button" class="btn btn-info btn-block"
                                            onclick="document.getElementById('inputFile').click()">Scegli fattura...
                                    </button>
                                    <div class="form-group inputDnD">
                                        <label class="sr-only" for="inputFile">File Upload</label>
                                        <input type="file" name="File"
                                               class="form-control-file text-info font-weight-bold" id="inputFile"
                                               accept="text/xml"
                                               data-title="oppure trascina qui la fattura in formato XML"/>
                                    </div>
                                    <p style="display: none;" class="fileMsg">È stato selezionato il file: <span
                                                class="fileName"></span></p>
                                    <input type="submit" name="submit" v-on:click="refreshTables();" value="Carica"
